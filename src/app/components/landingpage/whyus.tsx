...
export default function Whyus() {
    return(
        <>
        <div className="flex flex-col gap-12 px-52">
            <div className="font-primary text-5xl pl-4 text-dark dark:text-light ">
                Why Us?
            </div>

            <div className="grid grid-cols-2 items-center jusitfy-center gap-y-8">
                ...
                <div>
                    ...
                    width={400}
                    height={400}
                    className="rounded-2xl shadow-[0_6px_30px_rgba(0,0,0,0.1)] dark:shadow-[0_6px_40px_rgba(255,255,248,0.1)]"
                    />
                </div>
                ...
                <div className="font-secondary  tracking-tight text-dark dark:text-light text-2xl font-medium ">
